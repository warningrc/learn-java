...
object Array_Tuple_Map {
    def main(args: Array[String]): Unit = {
        val array = Array(1, " hello", " scala")
        for (s <- array) {
            print(s)
        }
        println
        ...
        val array1 = Array(1, 2, 3, 4, 5) //> array  : Array[Int] = Array(1, 2, 3, 4, 5)
        for (i <- array1) println(i) //> 1
        //| 2
        //| 3
        //| 4
        //| 5
        ...
        val arrayTest = Array(1, 2, 3, 4, 5, 6, 7, 8, 9, 0)
        for (num <- arrayTest.drop(1)) {
            println(num)
        }
