 ...
 * ensure that that the actual SqlSession used is the one associated with the current Spring
 * transaction. In addition, it manages the session life-cycle, including closing, committing or
 * rolling back the session as necessary based on the Spring transaction configuration.
 * <p>
...
public class RWSqlSessionTemplate implements SqlSession {
    ...
    public <V> List<V> selectList(String statement) {
        return this.sqlSessionProxy.selectList(statement);
    }

    public <V> List<V> selectList(String statement, Object parameter) {
        return this.sqlSessionProxy.selectList(statement, parameter);
    }

    public <V> List<V> selectList(String statement, Object parameter, RowBounds rowBounds) {
    ...
    /**
     * Proxy needed to route MyBatis method calls to the proper SqlSession got from String's
    ...
    private class SqlSessionInterceptor implements InvocationHandler {
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            MappedStatement statement =
                    RWSqlSessionTemplate.this.sqlSessionFactory.getConfiguration().getMappedStatement(statementId);
            ...
            final SqlSession sqlSession =
                    SqlSessionUtils.getSqlSession(RWSqlSessionTemplate.this.sqlSessionFactory,
